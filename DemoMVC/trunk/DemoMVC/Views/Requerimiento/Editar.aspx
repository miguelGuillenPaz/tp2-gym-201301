                        ...
                        <div class="texto-noticia">
                            ...
                            <table id="tblbody">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <%= requerimiento.codcorDetReq %>
                                        </td>
                                        <td>
                                            <%= requerimiento.desReq %>
                                        </td>
                                        <td>
                                            <%= requerimiento.codUM %>
                                        </td>
                                        <td>
                                            <%= requerimiento.descUM %>
                                        </td>
                                        <td>
                                            <%= requerimiento.canDetReq %>
                                        </td>
                                        <td>
                                            <%= requerimiento.codTipoServ %>
                                        </td>
                                        <td>
                                            <%= requerimiento.descTipoServ %>
                                        </td>
    ...
    <div id="dialogRequerimiento" style="display: none;">
        ...
        <table style="width: 100%">
            <tbody>
                ...
                <tr>
                    <td colspan="3">
                        <input id="txtDescripcion" type="text" style="width: 98%" />
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <%= Html.DropDownList("idUnidadMedida", (IEnumerable<SelectListItem>)ViewData["UnidadMedida"])%>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input id="txtCantidad" type="number"  min="0"  value="1"/>
                    </td>
                </tr>
                <tr>
                    <td>
