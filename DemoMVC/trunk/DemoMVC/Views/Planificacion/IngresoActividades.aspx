		...
		<h3>Asignar Actividades:</h3>
			...
			<table id='Tabla1' >
              ...
              <% 
			      ...
			      <tr>
                    <td align="center"><input type="checkbox" id='chk_<%: item.corAct %>' name='chk_<%: item.corAct %>' /></td>
                    <td align="center">
                    ...
                    <td><input id="txt_dur<%: item.corAct %>" name="txt_dur<%: item.corAct %>" value=''  size='10' />dias</td>
