<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<DemoMVC.Models.GD_TipoDocumento>" %>
                        ...
                        <div class="texto-noticia">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>                                        
                                        <%= Html.TextBoxFor(m => m.Vigencia, new { @required = "required", @Style = "width:50%;" })%> (Años)
                                    </td>                               
                                </tr>                                                     
                            </table>                            
                        </div>
